...
$sql = "
    SELECT 
        ...
        COALESCE(creator.full_name, creator.username, 'N/A') AS created_by,
        GROUP_CONCAT(DISTINCT COALESCE(assignee.full_name, assignee.username, 'Unassigned') SEPARATOR ', ') AS assigned_to,
